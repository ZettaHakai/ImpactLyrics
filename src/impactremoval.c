...
static s16 scenario_text_000C[] = { PCT_SPACE,CTR_ENDLINE };
static s16 scenario_text_0100[] = { PCT_SPACE,CTR_NEWLINE,CTR_ENDLINE };
static s16 scenario_text_0108[] = { PCT_SPACE,CTR_ENDLINE };
static s16 scenario_text_0110[] = { PCT_SPACE,CTR_NEWLINE,CTR_ENDLINE };
static s16 scenario_text_0118[] = { PCT_SPACE,CTR_NEWLINE,CTR_ENDLINE };
static s16 scenario_text_0120[] = { PCT_SPACE,CTR_ENDLINE };
static s16 scenario_text_0128[] = { PCT_SPACE,CTR_NEWLINE,CTR_ENDLINE };
static s16 scenario_text_0130[] = { PCT_SPACE,CTR_ENDLINE };
static s16 scenario_text_0138[] = { PCT_SPACE,CTR_NEWLINE,CTR_ENDLINE };
static s16 scenario_text_0140[] = { PCT_SPACE,CTR_ENDLINE };
static s16 scenario_text_0148[] = { PCT_SPACE,CTR_NEWLINE,CTR_ENDLINE };
static s16 scenario_text_0150[] = { PCT_SPACE,PCT_EXCLAMATION,CTR_NEWLINE,CTR_ENDLINE };
static s16 scenario_text_0158[] = { PCT_SPACE,CTR_NEWLINE,CTR_ENDLINE };
static s16 scenario_text_0160[] = { PCT_SPACE,CTR_ENDLINE };
static s16 scenario_text_0168[] = { PCT_SPACE,CTR_NEWLINE,CTR_ENDLINE };
static s16 scenario_text_0170[] = { PCT_SPACE,CTR_ENDLINE };
static s16 scenario_text_0178[] = { PCT_SPACE,CTR_ENDLINE };
static s16 scenario_text_0180[] = { CTR_END, CTR_ENDLINE };

// ===== Scenario Code =====
s32 scenario_code_impact_removed[];
...
s32 scenario_code_impact_removed[] = {
    ...
    STW, (s32)&D_801C7740_1C8340, WTS, 0x2A, ESR, (s32)&func_8003F460_40060,
    ...
    STW, (s32)&D_801C7740_1C8340, WTS, 0x62, ESR, (s32)&func_8003F460_40060,
